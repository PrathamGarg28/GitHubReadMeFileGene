...
const Work = (props) => {
  ...
  return (
    <div className="flex justify-center items-start flex-col w-full px-2 sm:px-6 mb-10">
      <div className="text-xl sm:text-2xl font-bold font-title mt-2 mb-2">Work Experiences</div>
      <div className="text-xs sm:text-lg flex flex-col sm:flex-row mb-10 justify-center sm:justify-start items-center sm:items-start w-full px-4 sm:px-0">
        <input
          ...
          placeholder="Hi, I'm "
          className="outline-none placeholder-gray-700 mr-8 w-full sm:w-1/3 border solid border-gray-900 py-1 px-2 focus:border-red-700"
        ...
        <input
          ...
          className="outline-none placeholder-gray-700 mr-8 w-full sm:w-1/4 border solid border-gray-900 py-1 px-2 focus:border-red-700"
        ...
        <input
          ...
          className="outline-none placeholder-gray-700 mr-8 sm:mr-0 text-blue-700 w-full sm:w-1/4 border solid border-gray-900 py-1 px-2 focus:border-red-700"
      ...
      <div className="text-xs sm:text-lg flex flex-col sm:flex-row mb-10 justify-center sm:justify-start items-center sm:items-start w-full px-4 sm:px-0">
        <input
          ...
          className="outline-none mr-8 w-full sm:w-1/3 border solid border-gray-900 py-1 px-2 focus:border-red-700"
      ...
      <div className="text-xs sm:text-lg flex flex-col sm:flex-row mb-10 justify-center sm:justify-start items-center sm:items-start w-full px-4 sm:px-0">
        ...
        <input
          ...
          className="outline-none placeholder-gray-700 w-full sm:w-1/3 border solid border-gray-900 py-1 px-2 focus:border-red-700"
      ...
      <div className="text-xs sm:text-lg flex flex-col sm:flex-row mb-10 justify-center sm:justify-start items-center sm:items-start w-full px-4 sm:px-0">
        ...
        <input
          ...
          className="outline-none placeholder-gray-700 mr-8 sm:mr-0 w-full sm:w-1/3  border solid border-gray-900 py-1 px-2 focus:border-red-700"
          value={data.ama}
      ...
      <div className="text-xs sm:text-lg flex flex-col sm:flex-row mb-10 justify-center sm:justify-start items-center sm:items-start w-full px-4 sm:px-0">
        ...
        <input
          ...
          className="outline-none placeholder-gray-700 mr-8 sm:mr-0 text-blue-700 w-full sm:w-1/3 border solid border-gray-900 py-1 px-2 focus:border-red-700"
