  ...
  return (
    <div className="flex justify-center items-start flex-col w-full px-2 sm:px-6 mb-10">
      ...
      <div className="flex justify-start items-center w-full text-regular text-xs sm:text-lg">
        <input
          id="title-prefix"
          className="outline-none w-24 sm:w-40 mr-10 border solid border-gray-900 py-1 px-2 focus:border-red-700 prefix"
          value={prefix.title}
        ...
        <input
          id="title-name"
          placeholder="Name"
          className="outline-none placeholder-gray-700 w-1/2 sm:w-1/3 border solid border-gray-900 py-1 px-2 focus:border-red-700"
          value={data.title}
