...
const social = (props) => {
  ...
  return (
    <div className='px-2 sm:px-4 mb-4'>
        <div className='text-xl  xm:text-2xl font-bold font-title mt-2 mb-2'>Social Handles</div> 
        <div className='flex flex-wrap justify-center items-center'>
            <div className='w-1/2 flex justify-center items-center text-xxs sm:text-lg py-4 pr-2 sm:pr-0'>
                ...
                alt="github" className="w-6 h-6 sm:w-8 mr-1 sm:mr-4"/>
                <input
                    id="github" placeholder='github username'
                    className='outline-none placeholder-gray-700 w-32 sw:w-1/2outline-none placeholder-gray-700 focus:placeholder-gray-500 w-32 sm:w-1/2  border solid border-gray-900 py-1 px-1 sm:px-2 focus:border-red-700 border solid border-gray-900 py-1 px-1 focus:border-red-700'
                    value={social.github}
